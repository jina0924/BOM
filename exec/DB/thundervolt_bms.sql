...
CREATE TABLE `bms` (
  ...
  PRIMARY KEY (`id`),
  KEY `bms_patient_id_52ab1f44_fk_patient_id` (`patient_id`),
  CONSTRAINT `bms_patient_id_52ab1f44_fk_patient_id` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`)
...
INSERT INTO `bms` VALUES (1,24,0,1),(2,24,0,28);
...
-- Dump completed on 2022-11-21 16:37:03
