            ...
            <div className="info-zone col-span-5">
                ...
                <div className="information-zone flex flex-col">
                    ...
                    <div className="ward-info-summary-list grid grid-cols-4 p-7 gap-8">
                        ...
                        {/* 입원 환자 수 */}
                        <Link to="/patients">
                            <WardInfo wardInfoTitle="patientCount" wardInfoDetail={patientCount} />
                        </Link>
                        {/* 의사 수 */}
                        <Link to="/doctors">
                            <WardInfo wardInfoTitle="doctorCount" wardInfoDetail={doctorCount} />
                        </Link>
                        {/* 간호사 수 */}
                        <Link to="/nurses">
                            <WardInfo wardInfoTitle="nurseCount" wardInfoDetail={nurseCount} />
                        </Link>
                    </div>
                    {/* 병동 상세 데이터 카드 */}
