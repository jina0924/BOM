  ...
  return (
    <>
      <div className="patient-device-summary w-full h-full bg-white rounded-lg shadow-box">
        <div className="top-box flex justify-between h-1/6">
          <div className="title-box font-extrabold flex items-start p-3">
            <Title
          ...
          <div className="arrow-box p-3  h-1/6" onClick={onZoom}>
