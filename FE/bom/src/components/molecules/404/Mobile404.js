...
function Mobile404({ userType = "guest" }) {
    ...
    <div className="404 bg-back w-[100vw] h-[100vh] flex justify-center items-center">
      <div className="404-box w-4/5 h-4/5 bg-white rounded-[20px] shadow-box flex flex-col justify-center">
        ...
        <div className="404-box flex justify-center">
          <span className="text-main font-extrabold text-[80px]">404</span>
        </div>
        <div className="wrong-path-box flex justify-center pb-10">
          <span className="text-main ">잘못된 경로입니다.</span>
        </div>
        <div className="btn-box flex justify-center text-sm">
          <Btn
            className="bg-main text-white px-5 py-2 rounded-[20px]"
            content={btnContent}
            onClick={
              userType === "patient"
                ? toPatientDetail
